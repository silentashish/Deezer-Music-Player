...
export default class App extends React.Component {
  ...
  componentDidMount() {
    console.log(this.props.navigation.state.params.music);
    var MusicData = this.props.navigation.state.params.music;
    this.PLAYLIST = [
      new PlaylistItem(MusicData.title, MusicData.preview, false),
    ];
